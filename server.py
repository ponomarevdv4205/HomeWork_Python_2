...
import sys
import json
from config import STATUS, ACTION, ACCOUNT_NAME, RESPONSE, MAX_CONNECTIONS, PRESENCE, TIME, USER, ERROR, DEFAULT_PORT
...
def client_message(message):
    ...
    if ACTION in message and message[ACTION] == PRESENCE and TIME in message \
            and USER in message and message[USER][ACCOUNT_NAME] == 'Dima' and STATUS == 'online':
        return {RESPONSE: 200}
    return {
        RESPONSE: 400,
