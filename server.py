...
from config import ACTION, ACCOUNT_NAME, RESPONSE, MAX_CONNECTIONS, PRESENCE, TIME, USER, ERROR, DEFAULT_PORT, \
    MESSAGE, MESSAGE_TEXT, SENDER, RESPONSE_200, RESPONSE_400, DESTINATION, EXIT
...
def main():
    ...
    print('Это Серверный модуль.')
    print('Все сообщения от Сервера будут помещаться в файл "...logs\server_log.log".')
