...
class my_TestClass(unittest.TestCase):
    ...
    def test_def_presense(self):
        ...
        test[TIME] = 1.1
        self.assertEqual(test, {ACTION: PRESENCE, TIME: 1.1, USER: {ACCOUNT_NAME: 'Dima'}, STATUS: 'online'})

    # Тест № 2 на удачное подключение:
    def test_200(self):
        self.assertEqual(process_ans({RESPONSE: 200}), '200: ответ сервера получен')
